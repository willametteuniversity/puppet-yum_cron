...
class yum_cron::config {
  ...
  if $yum_cron::ensure == 'present' {
    ...
    # Handle Scientific Linux special cases
    if $::os['name'] =~ /Scientific/ and $yum_cron::yum_autoupdate_ensure == 'disabled' {
